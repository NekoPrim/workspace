...
int main() {
    ...
    vector <int> test_scores {100, 96, 89};
    ...
    int score_to_add (0); // initialize to 0
    cin >> score_to_add;
    ...
    // cout << "This should cause and exception!" << test_scores.at(10) << endl; // There are not 10 elements in the vector
